                ...
                >
                    ...
                    <div className="p-4 flex flex-col gap-3">
                        <div className="flex justify-between items-center border-b border-gray-800 pb-2">
                            ...
                            {flight.alert_operator && flight.alert_operator !== t("ui.unknown") ? (
                                <a
                ...
                >
                    ...
                    <div className="p-4 flex flex-col gap-3">
                        ...
                        <div className="flex justify-between items-center border-b border-gray-800 pb-2">
                            ...
                            <span className="text-cyan-400 text-xs font-bold">{flight.origin_name !== t("ui.unknown") ? `[${flight.origin_name}] → [${flight.dest_name}]` : t("ui.unknown")}</span>
                        </div>
                        {flight.icao24 && (
                            <div className="flex justify-between items-center border-b border-gray-800 pb-2">
                                <span className="text-gray-500 text-[10px]">{t("ui.flightRecord")}</span>
                ...
                >
                    ...
                    <div className="p-4 flex flex-col gap-3">
                        ...
                        <div className="flex justify-between items-center border-b border-gray-800 pb-2">
                            ...
                            <span className={`text-xs font-bold ${ship.destination && ship.destination !== t("ui.unknown") ? 'text-cyan-400' : 'text-orange-400'}`}>{ship.destination || t("ui.unknown")}</span>
                        </div>
                        <div className="flex justify-between items-center border-b border-gray-800 pb-2">
